package ru.cynteka.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "ru.cynteka.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "ru.cynteka.springboot.model" });
